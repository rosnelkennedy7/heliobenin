...
export default function AdminUtilisateurs() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      if (e) console.error('[Supabase] profiles:', e)
      setUtilisateurs(data || [])
    } catch (e) {
      console.error('[Utilisateurs load]', e)
      ...
      <div style={{ position: 'relative', zIndex: 1, color: '#fff', fontFamily: 'inherit' }}>
        ...
        <div style={{ maxWidth: 960, margin: '0 auto', padding: '1.5rem 1rem' }}>
          ...
          <input
            ...
            style={{ width: '100%', boxSizing: 'border-box', marginBottom: '1rem', background: 'rgba(255,255,255,0.06)', border: '1.5px solid rgba(255,255,255,0.1)', borderRadius: 9, padding: '0.7rem 1rem', color: '#fff', fontSize: '0.95rem', outline: 'none', fontFamily: 'inherit' }}
          />
