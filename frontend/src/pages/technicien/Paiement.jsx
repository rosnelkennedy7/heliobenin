  ...
  if (statut === "success") {
    return (
      <div
        ...
        style={{ backgroundImage: `url(${vitreImg})` }}
      >
        ...
        <div className={styles.card}>
          ...
          <div className={styles.formules}>
            {FORMULES.map((f) => (
              ...
              >
                {f.badge && (
                  <span className={styles.formuleBadge}>{f.badge}</span>
                )}
